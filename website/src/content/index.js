/*
*Here are information stored that is used throughout the webpage, like color hexcodes, default texts, links, logo, stock images and such
* use "import content from '../content';" and eg ${content.color.Lightshade} to retrieve the hexcode value for lightshade.
*/

export default {
    logo: process.env.PUBLIC_URL + '/assets/logo.png', // "process.env.PUBLIC_URL" will rout to the "public" folder in the react project
    color: {
        LightShade: '#F3F3ED', // << here is the example value given
        LightAccent: '#BD9C74',
        BrandColor: '#A7AC38',
        DarkAccent: '#C4A53E ',
        DarkShade: '#2E4136',
        BackgroundShade: '#DEDED4', //The color behind the container.
    },
    nav: {
        Hamburger_icon: process.env.PUBLIC_URL + '/assets/Hamburger_icon.png',
        icon: process.env.PUBLIC_URL + '/assets/icon.png',
        Recipes: "Recipies",
        NewRecipie: { text: 'New Recipe', to: '/create' },
        Browse: { text: 'Browse', to: '/browse' },
        links: [
    ...
    assets: {
        ...
        imagePlaceholder: "https://th.bing.com/th/id/R.e0d9b729a84bb7023cf1523234429b86?rik=Hr2O5Ah9J%2bdnVg&riu=http%3a%2f%2fkelleyandcricket.com%2fwp-content%2fuploads%2f2016%2f01%2fMeatball5-1024x1024.jpg&ehk=ZZTine4JSx0i0Wv4n804Ko6ll2bGXBX4t3nMHHoEx7E%3d&risl=&pid=ImgRaw&r=0?text=First slide&bg=f5f5f5",
    },
};
